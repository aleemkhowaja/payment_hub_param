...
<tr role="row" class="ui-subgrid">
	...
	<ps:url id="webServiceGuiSubGridUrl" action="WebServiceExplorerList_loadSubGridInfo" namespace="/path/common/WebserviceExplorer" escapeAmp="false">
		...
		{
		%>
			<psjg:gridColumn name="mappingField" title="%{getText('mappingfield_key')}" index="MAPPINGFIELD" 
				colType="select" search="false"  formatter="select" editable="true" sortable="false" id="MAPPINGFIELD_${_pageRef}"  edittype="select" 
				loadOnce="true"
				hidden=""
				editoptions="{value:function(){
				return mappingFieldsLoadCombo('${pageContext.request.contextPath}/path/common/WebserviceExplorer/WebServiceExplorerMaint_fillMappingFields','mappingValues','code', 'descValue');}
				,dataEvents: [{ type: 'change', fn: function(e) { onMappingFieldChange(e) } }
				]
				}
				" 
			/>
