...
<script type="text/javascript">
	...
	<#if (additionalFieldsByTypeCOList?? && additionalFieldsByTypeCOList?size>0) >
		<#assign index=1/>   <#assign trCounter=1/> <#assign trOpen=0/> 
		...
		<@ps.iterator value="additionalFieldsByTypeCOList" var="additionalFieldsByType" status="addFieldStatus">
			<#if additionalFieldsByTypeCOList[addFieldStatus.index].cifDataAddFieldsVO.ENTITY?? && additionalFieldsByTypeCOList[addFieldStatus.index].cifDataAddFieldsVO.ENTITY =="CIF">	
				...
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].CODE' ></@ps.hidden>
			...
			<#elseif additionalFieldsByTypeCOList[addFieldStatus.index].ctstrsDataAddFieldsVO.ENTITY?? && additionalFieldsByTypeCOList[addFieldStatus.index].ctstrsDataAddFieldsVO.ENTITY =="CTSTRS">	
				...
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].CODE' ></@ps.hidden>
			<#elseif additionalFieldsByTypeCOList[addFieldStatus.index].ctsCardsDataAddFieldsVO.ENTITY?? && additionalFieldsByTypeCOList[addFieldStatus.index].ctsCardsDataAddFieldsVO.ENTITY =="CARD">	
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.BRANCH_CODE' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.COL_NO' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.COMP_CODE' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.ENTITY' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.ENTITY_TYPE' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].ctsCardsDataAddFieldsVO.APPLICATION_ID' ></@ps.hidden>
				<@ps.hidden name='additionalFieldsByTypeCOList[${addFieldStatus.index}].CODE' ></@ps.hidden>				
			</#if>	
			...
			<#if additionalFieldsByTypeCOList[addFieldStatus.index].FIELD_TYPE!="L">
				...
				<td class="fldLabelView">
					<#if (additionalFieldsByTypeCOList[addFieldStatus.index].FIELD_TYPE=="N" || additionalFieldsByTypeCOList[addFieldStatus.index].FIELD_TYPE=="V") && additionalFieldsByTypeCOList[addFieldStatus.index].LOOKUP_TYPE =="S" >
				...
				<#if additionalFieldsByTypeCOList[addFieldStatus.index].FIELD_TYPE=="V">
					...
					<#elseif additionalFieldsByTypeCOList[addFieldStatus.index].LOOKUP_TYPE =="S" >
						...
						<td valign="middle" colspan="2">
							...
							<@psj.livesearch id="addFieldsByType_${additionalFieldsByType.FIELD_SEQ}_${_pageRef}" name="additionalFieldsByTypeCOList[${addFieldStatus.index}].ADD_VC" 
					   			mode = "text"
					   			...
					   			parameter="dependencyString:lookuptxt_addFieldsByType_${additionalFieldsByType.FIELD_SEQ}_${_pageRef},CTS_ADD_FIELDSVO_CODE:additionalFieldsByTypeCODE_${additionalFieldsByType.FIELD_SEQ}_${_pageRef},COLUMN_NUMBER:additionalFieldsByTypeCOLUMN_NUMBER_${additionalFieldsByType.FIELD_SEQ}_${_pageRef},compCode:additionalFieldsByTypeCOMP_CODE_${additionalFieldsByType.FIELD_SEQ}${additionalFieldsByType.additionalParam}" >
							</@psj.livesearch>
						</td>
						<#if additionalFieldsByType.DESC_OUTPUT?? >
					    <td >  	
