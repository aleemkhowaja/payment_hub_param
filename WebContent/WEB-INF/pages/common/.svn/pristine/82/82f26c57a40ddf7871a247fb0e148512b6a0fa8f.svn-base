...
<ps:hidden name="custCO.sysParamObjDisplayVO.OBJ_DISPLAY_ID" id="objectDisplayID"/>
	...
	<table border="0" cellpadding="1" cellspacing="0" width="100%">
		...
		<tr>
			...
			<%/* Custom Activity on Columns global activity */%>
			<ps:if test="%{(fromLiveSearch == 0 || fromLiveSearch == null) && readOnlyFlag == false }">
				<tr>
					<td>
						<div id="grid_elem_activity_div_${_pageRef}">
							<%@include file="ObjectCustomElementActivityGrid.jsp"%>
						</div>
					</td>
				</tr>
				<tr>
					<td><div id="objcustElem_parmaMapGrid_<ps:property value="_pageRef" escapeHtml="true"/>"></div></td>
				</tr>
			</ps:if>
	</table>
</ps:form>
