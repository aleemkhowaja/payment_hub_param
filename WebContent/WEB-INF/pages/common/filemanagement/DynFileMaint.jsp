...
<body> 	 
	<jsp:include page="/WEB-INF/pages/common/login/InfoBar.jsp" />
 	<ps:form id="dynaFileForm_${_pageRef}"   method="post"  enctype="multipart/form-data"  namespace="/path/fileMngmt"   >	
 	    ...
 	    <ps:hidden id="fileProcessing_${_pageRef}" ></ps:hidden> 	     
 	    ...
 	    <fieldset class="ui-widget-content ui-corner-all">	    				 
			 ...
			 <tr>
			 	...
			 	<td width="10%"></td>
				  ...
				  <tr>
				    <td width="15%"><ps:label key="Enquiry_File_Code_key"/></td>
				    <td width="10%">
				    ...
				    <td width="35%"><ps:textfield id="fileDesc_${_pageRef}"
						name="dynFilesDetCO.dfDataFileVO.FILE_DESC" readonly="true" tabindex="-1" ></ps:textfield></td>
				    <td width="10%" hidden="true"><ps:textfield id="fileExt_${_pageRef}"
