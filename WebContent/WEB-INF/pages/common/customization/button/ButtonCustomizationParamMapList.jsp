...
<ps:set var="gridTitle" value="%{getEscText('parameters_key')}" />
<ps:if test="%{criteria.sysParamGlobalActArgMapVO.DYN_SCREEN_ID == null}">
	<ps:set var="gridTitle" value="%{getEscText('custom_activity_param_key')}" />
</ps:if>
