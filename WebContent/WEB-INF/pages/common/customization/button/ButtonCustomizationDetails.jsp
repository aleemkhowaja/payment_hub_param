...
<ps:form id="buttonCustomizationDetailsForm_${_pageRef}" useHiddenProps="true">	
	...
	<div>
		...
		<ps:if test='%{!"true".equals(buttonCustomizationCO.globalOperationMode)}'>
			<tr>
			<td>
					<ps:label id="lbl_sysParamBtnCustVO_VISIBILITY_EXPRESSION_${_pageRef}" 
							  for="sysParamBtnCustVO_VISIBILITY_EXPRESSION_${_pageRef}"
							  key="visibility_expr_key" cssStyle="padding-left: 8px;"/>
			</td>
				<td colspan="3">
					<ps:textarea id="sysParamBtnCustVO_VISIBILITY_EXPRESSION_${_pageRef}" 
								  name="buttonCustomizationCO.sysParamBtnCustVO.VISIBILITY_EXPRESSION" 
								  />
			</td>
			</tr>
			<tr>
