...
<ps:hidden id="objCustParamMapGrid_PROG_REF_${_pageRef}" name="criteria.sysParamGlobalActArgMapVO.PROG_REF"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_APP_NAME_${_pageRef}" name="criteria.sysParamGlobalActArgMapVO.APP_NAME"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_currentPageRef_${_pageRef}" name="_pageRef"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_ELEM_FLD_IDENTIFIER_${_pageRef}" name="criteria.sysParamGlobalActArgMapVO.ELEM_FLD_IDENTIFIER"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_BTN_ID_${_pageRef}" name="criteria.sysParamGlobalActArgMapVO.BTN_ID"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_LOADED_IN_OBJ_DISPLAY_${_pageRef}" name="criteria.loadedInObjDisplay"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_GRID_COLUMNS_${_pageRef}" name="criteria.gridColumns"></ps:hidden>
<ps:hidden id="objCustParamMapGrid_GRID_COLUMN_NAME_${_pageRef}" name="criteria.gridColumnName"></ps:hidden>
<ps:hidden id="objCust_confirmDialog_${_pageRef}" value="true" />

<ps:url id="objCustParamMapGridURL" action="buttonCustomizationParamListAction_loadParamMapGrid" namespace="/path/buttoncustomization" escapeAmp="false">
...
<psjg:grid id="ObjCustParamMapGrid_Id_${_pageRef}"
	dataType="json"
	href="%{objCustParamMapGridURL}"
	caption="%{getText('cust_activity_cols_param_key')}"
	hiddengrid="false"
	pager="true"
	pagerButtons="false"
	altRows="false"
	...
	sortable="true"
	editinline="true"
	addfunc="objCustParamMapGrid_addMapGrid"
	delfunc="objCustParamMapGrid_deleteMapGrid"
	onEditInlineBeforeTopics="objCustParamMapGrid_onRowSelTopic"
	editurl="dummy">

	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_ID" name="sysParamGlobalActArgMapVO.MAP_ID" title="%{getText('map_id_key')}" index="MAP_ID" colType="number"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_ELEM_FLD_IDENTIFIER" name="sysParamGlobalActArgMapVO.ELEM_FLD_IDENTIFIER" title="" index="ELEM_FLD_IDENTIFIER" colType="number" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_APP_NAME" name="sysParamGlobalActArgMapVO.APP_NAME" title="" index="APP_NAME" colType="text" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_PROG_REF" name="sysParamGlobalActArgMapVO.PROG_REF" title="" index="PROG_REF" colType="text" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_SCREEN_ELEM_PROG_REF" name="sysParamGlobalActArgMapVO.SCREEN_ELEM_PROG_REF" title="" index="SCREEN_ELEM_PROG_REF" colType="text" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_BTN_ID" name="sysParamGlobalActArgMapVO.BTN_ID" title="" index="BTN_ID" colType="number" hidden="true"/>	
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_DIRECTION_DESC"
					...
					,dataEvents: [{ type: 'change', fn: function() { objCustomizationParamMapGrid_mapDirectionChanged() } }]}"
					search="true" 
					required="true"
	/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_DIRECTION" name="sysParamGlobalActArgMapVO.MAP_DIRECTION" title=""	index="MAP_DIRECTION" colType="text" hidden="true" />
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_OP_ID" colType="liveSearch"
			...
			afterDepEvent="objCustomizationParamMapGrid_afterOP_IDDependency" 
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_OP_ID_DESCRIPTION" name="opIdDescription" title="%{getText('oper_description_key')}" index="opIdDescription" colType="text" />		
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_ARG_DESCRIPTION" name="argDescription" title="%{getText('oper_arg_description_key')}" index="argDescription" colType="text" />
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_TYPE" name="sysParamGlobalActArgMapVO.MAP_TYPE" title="" index="mapDescription" colType="text" hidden="true"/>	
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_TYPE_DESC"
					...
					,dataEvents: [{ type: 'change', fn: function() { objCustomizationParamMapGrid_mapTypeChanged() } }]}"
					search="true" 
	/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_MAP_VALUE" name="sysParamGlobalActArgMapVO.MAP_VALUE" title="%{getText('Value_key')}" index="MAP_VALUE" colType="text" editable="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_SCREEN_FLD_IDENTIFIER" name="sysParamGlobalActArgMapVO.SCREEN_FLD_IDENTIFIER" title="" index="SCREEN_FLD_IDENTIFIER" colType="number" hidden="true"/>
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_SCREEN_FLD_IDENTIFIER_DESC" colType="liveSearch"
				...
				paramList="criteria.mapType:sysParamGlobalActArgMapVO.MAP_TYPE,criteria.currAppName:objCustParamMapGrid_APP_NAME_${_pageRef},criteria.progRef:objCustParamMapGrid_currentPageRef_${_pageRef},criteria.gridColumns:objCustParamMapGrid_GRID_COLUMNS_${_pageRef}" 
				...
				params="buttonCustomizationCO.sysParamActionArgMapVO.MAP_VALUE:screenFldIdDesc_lookuptxt,buttonCustomizationCO.sysParamActionArgMapVO.MAP_TYPE:sysParamGlobalActArgMapVO.MAP_TYPE,buttonCustomizationCO.sysParamBtnCustVO.APP_NAME:objCustParamMapGrid_APP_NAME_${_pageRef},buttonCustomizationCO.sysParamBtnCustVO.PROG_REF:objCustParamMapGrid_currentPageRef_${_pageRef},buttonCustomizationCO.gridColumns:objCustParamMapGrid_GRID_COLUMNS_${_pageRef}"
				...
				afterDepEvent="objCustEnableDisableSelectionType()"
	/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_Description" name="mapDescription" title="%{getText('screen_fld_description_key')}" index="mapDescription" colType="text" editable="false"/>	
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_DELIMITER"  name="sysParamGlobalActArgMapVO.DELIMITER" title="%{getText('delimiter_key')}" index="DELIMITER" colType="text"  editable="true" editoptions="{maxlength:'15'}"/>
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_DYN_PARAM_TYPE_DESC"
					...
					,dataEvents: [{ type: 'change', fn: function() { objCustomizationParamMapGrid_dynParamTypeChanged() } }]}"
					search="false" 
	/>
	...
	<psjg:gridColumn id="sysParamGlobalActArgMap_DYN_ELEM_DESCRIPTION" name="dynElemDescription" title="%{getText('dyn_elem_description_key')}" index="dynElemDescription" colType="text" />

	<psjg:gridColumn id="sysParamGlobalActArgMap_CREATED_BY" name="sysParamGlobalActArgMapVO.CREATED_BY" title="CREATED_BY" index="CREATED_BY" colType="text" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_CREATED_DATE" name="sysParamGlobalActArgMapVO.CREATED_DATE" title="CREATED_DATE" index="CREATED_DATE" colType="date" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_MODIFIED_DATE" name="sysParamGlobalActArgMapVO.MODIFIED_DATE" title="MODIFIED_DATE" index="MODIFIED_DATE" colType="date" hidden="true"/>

	<psjg:gridColumn id="sysParamGlobalActArgMap_MODIFIED_BY" name="sysParamGlobalActArgMapVO.MODIFIED_BY" title="MODIFIED_BY" index="MODIFIED_BY" colType="text" hidden="true"/>	

	<psjg:gridColumn id="sysParamGlobalActArgMap_DYN_PARAM_TYPE" name="sysParamGlobalActArgMapVO.DYN_PARAM_TYPE" title="" index="DYN_PARAM_TYPE" colType="text" hidden="true"/>	

	<psjg:gridColumn id="fromSource" name="fromSource" title=""	index="" colType="text" hidden="true"/>

	<psjg:gridColumn id="gridColumnName" name="gridColumnName" title="" index="gridColumnName" colType="text" hidden="true"/>

</psjg:grid>
<script type="text/javascript">
	$.subscribe("objCustParamMapGrid_onRowSelTopic",function(rowObj){objCustParamMapGrid_onRowSelTopic(rowObj);});
</script>