...
<ps:set name="value_valid_exp_pos_values_key" 	   value="%{getEscText('value_valid_exp_pos_values_key')}"/>
...
<ps:form id="customizationMaintForm_${_pageRef}" applyChangeTrack="true">
	...
	<script type="text/javascript">
		...
		var fromSelectBox                   = '<ps:property value="fromSelectBox" escapeHtml="false" escapeJavaScript="true"/>';
		var value_valid_exp_pos_values_key  = '<ps:property value="value_valid_exp_pos_values_key" escapeHtml="false" escapeJavaScript="true"/>';
			    ...
			    <td>
			       <table cellpadding="0" cellspacing="0">
			       		<tr>
							...
							<% /* TP#1002338 added tooltip button for SelectBox */%>
							<ps:if test='%{"1".equals(fromSelectBox)}'>
								<td>
									<span title="${help_key_var}" class="ui-icon ui-icon-help" onclick="openCustValidExpToolTip()"></span>
									<div id="fldcust_valid_exp_tooltip_div" class="ui-corner-all" style="background-color: white; border: 1px solid rgb(0, 0, 0); display:none;"></div>
								</td>
							</ps:if>
			       		</tr>
				   </table>
