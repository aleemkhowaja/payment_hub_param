...
<ps:hidden name="criteria.dynScrParamMap" id="dynScrParamMap_${_pageRef}" ></ps:hidden>
...
var dynScrParamMap = $("#dynScrParamMap_"+ _pageRef).val();
$("#dynamicScreen_"+dynScreenId+"_Grid_"+ _pageRef).subscribe("onDynamicScreenGridComplete",function(){
    dynScrGridList_loadMainDiv();
  	//TP#1106431 Unsubscribe reconstruction of main div to avoid reconstruction on Grid reload and search
	$("#dynamicScreen_"+dynScreenId+"_Grid_"+ _pageRef).unsubscribe("onDynamicScreenGridComplete");
	});
</script>
