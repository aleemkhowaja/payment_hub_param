...
<ps:set name="cannot_dec_col_length_key_id" value="%{getEscText('cannot_dec_col_length_key')}"/>
<ps:set name="cannot_dec_decimal_val_key_id" value="%{getEscText('cannot_dec_decimal_val_key')}"/>
<ps:set name="cannot_del_saved_rows_key_id" value="%{getEscText('cannot_del_saved_rows_key')}"/>
<script type="text/javascript">
	var cannot_dec_col_length_key = '<ps:property value="cannot_dec_col_length_key_id" escapeHtml="false" escapeJavaScript="true"/>';
	var cannot_dec_decimal_val_key = '<ps:property value="cannot_dec_decimal_val_key_id" escapeHtml="false" escapeJavaScript="true"/>';
	var cannot_del_saved_rows_key = '<ps:property value="cannot_del_saved_rows_key_id" escapeHtml="false" escapeJavaScript="true"/>';
</script>
...
<psjg:grid id="dynScrTableColsGridId" 
		...
		onEditInlineAfterSaveTopics="defineScrTables_afterSaveTopics"
		onGridCompleteTopics="defineScrTables_completeTopics">
...
<ps:hidden id="dynScrTable_gridData"></ps:hidden>
<ps:hidden id="dynScrTable_SelRowId"></ps:hidden>
</fieldset>
</ps:form>
...
$.subscribe("defineScrTables_completeTopics",function(){defineScrTables_completeTopics();});
$.subscribe("defineScrTables_afterSaveTopics",function(){defineScrTables_afterSaveTopics();});
</script>
