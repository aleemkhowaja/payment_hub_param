		...
		//end tp#675239
		{
			...
			$.ajax({
				 ...
				 success: function(data){
					...
					{
					/**
					 * get the entity of the screen (CIF,AMF,CTSTRS...)
					 * in case it is from CIF we should update the some fields
					 */
					
					var entity = $("#additionalFieldsByTypeForm_"+_pageRef+"_additionalFieldsByTypeCOList_0__cifDataAddFieldsVO_ENTITY").val();
					if(entity=="CIF")
					{
						setCompCodeCif(data["additionalFieldsByTypeCO"]["compCodeCif"]);
