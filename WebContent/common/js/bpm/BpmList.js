function bpmUserTasksGrid_Id_BtnFormatter(cellValue, options, rowObject)
{
	...
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_releaseTask('+taskId+',\'' + deploymentId + '\')">' + bpm_release_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showClaimBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_claimTask('+taskId+',\'' + deploymentId + '\')">' + bpm_claim_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showCompleteBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_completeTask('+taskId+ ',' + processInstanceId + ',\'' + deploymentId + '\')">' + bpm_complete_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showOpenBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_openHumanTask('+taskId+',\'' + deploymentId + '\')">' + bpm_open_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showForwardBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_openForwardTask('+taskId+ ',\'' + deploymentId + '\')">' + bpm_forward_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showSuspendBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_openSuspendTask('+taskId+ ',\'' + deploymentId + '\')">' + bpm_suspend_key_trns + '</a></b></td></tr>';
	}
	if(rowObject["showResumeBtn"])
	{
		buttons += '<tr style="border-width:0" ><td style="border-width:0" class="ui-widget-content"><b><a href = "#" onclick = "bpmMaint_openResumeTask('+taskId + ',\'' + deploymentId +'\')">' + bpm_resume_key_trns + '</a></b></td></tr>';
	}
