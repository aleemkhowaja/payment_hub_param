function bpmMaint_openForwardTask(taskId, deploymentId)
{
	if(taskId != null && taskId != undefined)
	{
		...
		var curParams = { "bpmCO.bpmTaskId" : taskId, 'bpmCO.deploymentId':deploymentId};
...
function bpmMaint_releaseTask(taskId, deploymentId)
{
	if(taskId != null && taskId != undefined)
	{
		_showProgressBar(true);
		...
		$.ajax({
	         ...
	         type:"post",
			 dataType:"json",
			 data: {'bpmTaskId':taskId,'deploymentId':deploymentId},
			 success: function(data)
			 {
				 if(!(typeof data["_error"] == "undefined" || data["_error"] == null))
				 {
...
function bpmMaint_claimTask(taskId, deploymentId)
{
	if(taskId != null && taskId != undefined)
	{
		_showProgressBar(true);
...
function bpmMaint_completeTask(taskId,processInstanceId,deploymentId)
{
		...
		if(confirmcChoice)
		{
			...
			if(taskId != null && taskId != undefined)
			{
				...
				$.ajax({
			         ...
			         type:"post",
					 dataType:"json",
					 data: {'bpmTaskId':taskId,'processInstanceId':processInstanceId,'deploymentId':deploymentId},
					 success: function(data)
					 {
						 if(!(typeof data["_error"] == "undefined" || data["_error"] == null))
						 {
...
function bpmMaint_openHumanTask(taskId, deploymentId)
{
	_showProgressBar(true);
	$.ajax({
			  			...
			  			if(typeof data["_error"] == "undefined" || data["_error"] == null)
					 	{
					 	    //in case of normal screen
			  				if("1" == data["bpmCO"]["bpmTaskMappingCO"]["taskMapVO"]["ACTION_TYPE"])
			  				{
								...
								externalScreenParam["additionalParams"]["bpmDeploymentId"] =  data["bpmCO"]["deploymentId"];
...
function bpmProcessMapping_uploadBpmnFile() {
	...
	// accept files with extension 'bpmn' that is used in JBPM 7
	var bpmnFileExt = splitName.pop().toLowerCase(); 
	if (bpmnFileExt != "bpmn2" && bpmnFileExt != "bpmn") {
...
function bpmMaint_openSuspendTask(taskId, deploymentId)
{
	if(taskId != null && taskId != undefined)
	{
		var buttons = [];
		buttons.push({text:bpm_suspend_key_trns,id:"BpmCommonCommentPage_suspendBtn",click:function()
																	{
																		...
																		$.ajax({
																	         ...
																	         type:"post",
																			 dataType:"json",
																			 data: {'bpmCO.bpmTaskId':taskId,'bpmCO.comment':comment,'bpmCO.deploymentId':deploymentId},
																			 success: function(data)
																			 {
																			 	 if(typeof data["_error"] == "undefined" || data["_error"] == null)
																				 {
...
function bpmMaint_openResumeTask(taskId, deploymentId)
{
	if(taskId != null && taskId != undefined)
	{
		var buttons = [];
